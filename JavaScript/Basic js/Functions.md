...
[Самовызывающаяся функция - IIFE](#iife)<br>
...
## <a name='decloration'> Функция declaration (Объявление функции) </a> ##
...
## <a name='exspression'> Функция exspression (Функциональное выражение) </a> ##
...
```
## <a name="iife"> Самовызывающаяся функция </a> ##
