...
Обращаемся к DOM мы через объект document, этот объект содержит в себе всю структуру html.
### Устаревшие способы ###
...
console.log(bg); // <div id="bg-id"> Это просто div </div>
```
