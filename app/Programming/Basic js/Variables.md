...
Об этом много статей и сильно нет смысла углубляться.<br>
### Локальная облатсь ###
...
console.log(hi); // выводим ее вне блока и получаем строку hi (видимость var не ограничена условиями, циклами или другими блоками, кроме функции)
```
Используем функцию:
```javascript
