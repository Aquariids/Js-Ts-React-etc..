[Динамическая типизация](#dinamic)
...
## Динамическая типизация и статическая! ##
Динамическая типизация - это когда тип данных задается при объявлении значения.
Так же динамическая типизация подразумивает изменения одного типа данных на другой
Статическая - это когда мы указываем тип при создании переменной.
