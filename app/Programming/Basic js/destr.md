...
// тут же мы создали переменные со значениями в скобках {} и указали пустой объект. Мы как бы деструктуризируем объект без имени и без свойств, мы их помещаем сами.
