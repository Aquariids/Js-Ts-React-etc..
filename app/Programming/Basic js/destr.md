...
```
Немножко о пустом объекте который мы присваиваем при деструктуризации наших аргументов.
```javaScript
...
// тут же мы создали переменные со значениями в скобках {} и указали пустой объект. Мы как бы деструкутурируем объект без имени и без свойств, мы их помещаем сами.
// Эти свойства доллжны быть в какой либо конструкции, иначе мы не сможем их использовать, поэтому и присваиваем пустой объект {}.
console.log(a) // 2
```
