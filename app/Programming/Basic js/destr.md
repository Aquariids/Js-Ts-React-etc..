...
console.log(a) // 2
/* Для деструктуризации чего либо, нам нужно указать массив или объект, без этих контрукций мы не можем работать. Эти переменные или значения доллжны быть в какой либо конструкции, иначе мы не сможем их использовать, поэтому и присваиваем пустой объект {}. Если это будет уже созданный именованный и пустой объект, то это сработает так же, но сам объект так и останется пустым. Это синтаксис деструктуризации.*/
```
