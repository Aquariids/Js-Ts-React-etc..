...
// так же есть строгое равенство! ПРИМЕР:

console.log(2 * 5 == '10'); // true хотя там строка, просто js все перевел в числа, об этом было выше
// но строгое равно, Так же проверяет и тип!
...
// в примерах везде два аргумента,но можно их делать сколько душе угодно (пися && пися && пися && пися)
                        ...
                        // НЕ ! - меняет true на false и на оборот 
console.log(2 + 2 != 4); // false
console.log(2 + 3 != 4); // true

/* != - не равно !== - строгое не равно, так же проверяет и на тип */

console.log(2 + 2 !== 4); // false, так как 2 + 2 равняется 4
// по сути мы спрашиваем равняется ли 2 + 2  не четырем? а если мы сделаем так
