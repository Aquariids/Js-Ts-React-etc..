...
// JSON - это всего лишь набор пар - ключ: Значение как и вобъекте, главное правило, что все строки в двойных ковычках ""

/*
*                                       Посмотрим на практике
*/

const person = {  // представим, что этот объект нам нужно передать на серве  на бекенд. На прямую объект мы не можем отправить
...
//1) stringify() - превращает объект в нужный нам формат для отправки данных
console.log(JSON.stringify(person)); // получаем объект в котором все в "" кавычках

//2) parse() - возвращаем былой вид
