...
// 5) forEach() только для querySelectorAll

inSection.forEach(item => {
    item.style.backgroundColor ='green';
});
/*
 *                                                     2.2 Создаем свои элементы! 
*/                                                           
...
/*
 *                                                                   2.3 Работаем с css Селекторами! уже не inline! 
*/                                                        
...
/*
 *                                                                      2.4 - А теперь добавляем элемент в наш DOM дерево
*/                                                    
