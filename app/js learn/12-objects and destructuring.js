...
// объекты это структуры которые могут сохранять в себе любые типы данных в формате ключ: значение.
// также могут быть вложенные объекты и массивы
...
const options = {           // второй и более удобный способ, просто открыть фигурные скобки
    ...
    */
                                            // есть способ лучше! (МЕТОД) Object.keys
...
// Это когда мы из объекта вытасакиваем свойства наружу это вместо того что у нас на строке 63
