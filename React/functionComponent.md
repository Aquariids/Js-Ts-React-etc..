#### Все компоненты которые мы использовали были функциональными, поэтому на этом заострять внимание не нужно. Здесь мы просто поговорим как создавать и как хранить компненты.
